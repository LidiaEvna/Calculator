...
/**
 *
 *В классе Main используется исключение try/catch
 * @author Журавлева Лидия 21ИТ35
 */
public class Main {
    ...
    /**
     * Создание класса для реалиции основных функций калькулятора
     * @param previousResult
     * @return данная команда возвращает результат действия
     * @throws Exception отображает исключение
     */
